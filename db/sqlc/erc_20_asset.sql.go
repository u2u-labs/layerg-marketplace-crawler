...
const delete20AssetByAssetId = `-- name: Delete20AssetByAssetId :exec
DELETE
FROM erc_20_collection_assets
WHERE
    asset_id = $1
...
func (q *Queries) Delete20AssetByAssetId(ctx context.Context, assetID string) error {
	_, err := q.db.ExecContext(ctx, delete20AssetByAssetId, assetID)
	return err
}
